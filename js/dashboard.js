...
function renderView(tab) {
    ...
    switch(tab) {
        case 'totals':
            ...
            title = 'California Fatal Occupational Injuries Within the Scope of CFOI (2015-2024)';
        ...
        case 'gender':
            ...
            title = 'California Fatal Occupational Injuries by Gender (2015-2024)';
        ...
        case 'race':
            ...
            title = 'California Fatal Occupational Injuries by Race/Ethnicity (2015-2024)';
        ...
        case 'age':
            ...
            title = 'California Fatal Occupational Injuries by Age Group (2015-2024)';
            colors = colorPalette.multiColor;
            renderMultiLineChart(data, title, colors);
            break;
        ...
        case 'employment':
            ...
            title = 'California Fatal Occupational Injuries by Employment Status (2015-2024)';
            colors = colorPalette.gender;
            renderMultiLineChart(data, title, colors);
            break;
        ...
        case 'event':
            ...
            title = 'California Fatal Occupational Injuries by Fatal Event (2015-2024)';
            colors = colorPalette.multiColor;
            renderMultiLineChart(data, title, colors);
            break;
        ...
        case 'industry':
            ...
            title = 'California Fatal Occupational Injuries by Industry (2015-2024)';
            colors = colorPalette.multiColor;
            renderMultiLineChart(data, title, colors);
            break;
        ...
        case 'occupation':
            ...
            title = 'California Fatal Occupational Injuries by Occupation (2015-2024)';
            colors = colorPalette.multiColor;
            renderMultiLineChart(data, title, colors);
            break;
    }
